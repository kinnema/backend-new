...
export default class DizipalProvider extends BaseProvider {
  constructor() {
    super(
      ...
      true,
      "https://dizipal871-dotcom.gateway.web.tr"
    );
  }
