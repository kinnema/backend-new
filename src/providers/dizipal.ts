...
export default class DizipalProvider extends BaseProvider {
  constructor() {
    super(
      ...
      true,
      "https://dizipal872-dotcom.gateway.web.tr"
    );
  }
